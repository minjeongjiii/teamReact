      ...
      <div className="best_wrap">
        ...
        <div className="best_right">
          <ul className="best_right_top">
            <li>
              <img src={process.env.PUBLIC_URL + '/images/best_02.png'} alt="미니럭셔리즈"/>
              <p>{bests[0].name_eng}</p>
              <p>{bests[0].name_ko}</p>
              <button onClick={()=> setModalIsOpen(true)}>미리보기</button>
            </li>
            <li>
              <img src={process.env.PUBLIC_URL + '/images/best_03.png'} alt="블랙베리앤베이코롱"/>
              <p>{bests[1].name_eng}</p>
              <p>{bests[0].name_ko}</p>
              <button onClick={()=> setModalIsOpen(true)}>미리보기</button>
            </li>
            <li>
              <img src={process.env.PUBLIC_URL + '/images/best_04.png'} alt="바닐라앤아니스코롱"/>
          ...
          <ul className="best_right_bottom">
            <li>
              <img src={process.env.PUBLIC_URL + '/images/best_05.png'} alt="와일드블루벨바디앤핸드워시"/>
              <p>{bests[3].name_eng}</p>
              <p>{bests[3].name_ko}</p>
              <button onClick={()=> setModalIsOpen(true)}>미리보기</button>
            </li>
            <li>
              <img src={process.env.PUBLIC_URL + '/images/best_06.png'} alt="화이트자스민앤민트코롱"/>
              <p>{bests[4].name_eng}</p>
              <p>{bests[4].name_ko}</p>
              <button onClick={()=> setModalIsOpen(true)}>미리보기</button>
            </li>
            <li>
              <img src={process.env.PUBLIC_URL + '/images/best_07.png'} alt="미니럭셔리즈"/>
